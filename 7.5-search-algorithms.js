...
function linearSearch(target, array) {
  // Get arrau and target value (passed as parameters)

  // Set a counter i = 0
  for (var i = 0; i < array.length; i++){

  //Check if 4elemnt at arr [i] is equal to target
  if (array[i] == target){
  // If matches return index
  return i;
  }

  // If not match incrament i++, continue look to next element
  }
...
function binarySearch(target, array) {
  // 1. Sort array (assume its sorted)
